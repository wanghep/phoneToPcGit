...
public class SoftKeyboard extends InputMethodService implements
	...
	public InputConnection mInputConn = null;
	private static SoftKeyboard instance = null;
	public static final String TAG = "SoftKeyboard";
	private boolean connFlag = false; // input flag
	private AlphaIME malphaIme = null;
	...
	public void onStartInput(EditorInfo attribute, boolean restarting) {
		...
		mInputConn = getCurrentInputConnection();
		if (mInputConn == null) {
			Log.e(TAG, "onStartUp mInputConn is null");
		} else {
			Log.e(TAG, "onStartUp mInputConn is not null");
		}
	}
	...
	public void onFinishInput() {
		super.onFinishInput();
		connFlag = false; // close socket connection flag
	...
	public InputConnection getInputConnectionInstance() {
		return mInputConn;
	}
	...
	// alphaIME for keydownup
	public void alphaKeyDownUp(int keyEventCode) {
		// if (mInputConn == null) {
		// Log.e(TAG, "getCurrentInputConnection error!");
		// return;
		// }
		Log.e(TAG, "keyEventCode = " + keyEventCode);
		getCurrentInputConnection().sendKeyEvent(
				new KeyEvent(KeyEvent.ACTION_DOWN, keyEventCode));
		getCurrentInputConnection().sendKeyEvent(
				new KeyEvent(KeyEvent.ACTION_UP, keyEventCode));
	...
	public void createAlpaIME(){
		AlphaIME malphaIme = AlphaIME.getInstance();
		malphaIme.setService(this);
	}
}
